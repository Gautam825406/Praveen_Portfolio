            ...
            <div className="space-y-8">
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl rounded-2xl p-8 border border-white/10" style={{
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/praveen_vfx_?igsh=MTMwaDNqNHVxb2Fy" className="w-12 h-12 bg-white/5 hover:bg-gradient-to-br hover:from-yellow-400 hover:to-amber-500 rounded-xl flex items-center justify-center border border-white/10 hover:border-transparent transition-all transform hover:scale-110 group">
                  ...
                  <a href="https://youtube.com/@ajeetkumar0108?si=8MUxkoXJ4Glduntw" className="w-12 h-12 bg-white/5 hover:bg-gradient-to-br hover:from-yellow-400 hover:to-amber-500 rounded-xl flex items-center justify-center border border-white/10 hover:border-transparent transition-all transform hover:scale-110 group">
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-black transition" fill="currentColor" viewBox="0 0 24 24">
